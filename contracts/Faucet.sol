...
contract Faucet {
    IERC20 public token;
    uint256 public withdrawalAmount = 10 * (10**18); // 10 Tokens
    ...
    // Funcion para que el dueño pueda cambiar la cantidad de retiro
    // (Simplificada para el tutorial, en produccion usaria Ownable)
}
